...
from flask import Blueprint, Response, request, render_template, url_for, redirect, flash,jsonify,abort
...
def show_product():
    ...
    if USER_DATA["rol"]=="ROL_CLIENTE":
        abort(403)
    elif USER_DATA['rol']=="ROL_REPRESENTANTE":
    '''
    ...
    region=RESPONSE_BODY["data"][1]
    print(region)
    
    return render_template('home.html',region=region)
